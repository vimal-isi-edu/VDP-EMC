...
class PredEvaluator(object):
    def __init__(self, device, val_loader, model, num_gpus, num_plot_image, output_dir, args=None):
        # misc
        self.device = device
    ...
    def test(self):
        ...
        for batch_idx, (data, _, rois, gt_boxes, gt_masks, valid, g_idx, seq_l, _, _) in enumerate(self.val_loader):
            with torch.no_grad():
